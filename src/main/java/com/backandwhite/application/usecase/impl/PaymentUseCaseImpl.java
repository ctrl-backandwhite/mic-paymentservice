...
public class PaymentUseCaseImpl implements PaymentUseCase {
        ...
        @Override
        @Transactional
        public Payment processPayment(String orderId, String userId, String email, Money amount,
                ...
                if (!settlementCurrency.equalsIgnoreCase(displayCurrency)) {
                        ...
                        log.info("Currency routing: {} {} → {} {} (rate={})",
                                        amount.toPlainString(), displayCurrency,
        ...
        @Override
        @Transactional
        public Payment createCryptoPayment(String orderId, String userId, Money amount,
                ...
                if (!settlementCurrency.equalsIgnoreCase(displayCurrency)) {
                        ...
                        settlementAmount = Money.of(converted);
                        log.info("Crypto currency routing: {} {} → {} {} (rate={})",
                                        amount.toPlainString(), displayCurrency,
                                        settlementAmount.toPlainString(), settlementCurrency, exchangeRate);
                }
         ...
         * </ul>
         * For crypto (USDT ≈ 1 USD, BTC via CoinGecko-style rate) we treat
         * USDT as 1:1 with USD and BTC rate as stored.
         */

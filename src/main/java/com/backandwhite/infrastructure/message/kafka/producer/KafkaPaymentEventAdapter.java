...
public class KafkaPaymentEventAdapter implements PaymentEventPort {
    ...
    public void publishPaymentInitiated(String paymentId, String orderId, String userId, String amount, String currency,
        ...
        PaymentInitiatedEvent event = PaymentInitiatedEvent.newBuilder().setPaymentId(paymentId).setOrderId(orderId)
                .setUserId(userId).setEmail(null).setAmount(amount).setCurrency(currency).setMethod(method)
                .setGateway(gateway).setTimestamp(now()).build();
    ...
    public void publishPaymentConfirmed(String paymentId, String orderId, String userId, String email, String amount,
        ...
        PaymentConfirmedEvent event = PaymentConfirmedEvent.newBuilder().setPaymentId(paymentId).setOrderId(orderId)
                .setUserId(userId).setEmail(email).setAmount(amount).setCurrency(currency).setMethod(method)
                .setGateway(gateway).setTransactionRef(transactionRef).setTimestamp(now()).build();
    ...
    public void publishPaymentFailed(String paymentId, String orderId, String userId, String email, String amount,
        ...
        PaymentFailedEvent event = PaymentFailedEvent.newBuilder().setPaymentId(paymentId).setOrderId(orderId)
                .setUserId(userId).setEmail(email).setAmount(amount).setReason(reason).setGateway(gateway)
    ...
    public void publishRefundInitiated(String paymentId, String refundId, String orderId, String userId,
        ...
        PaymentRefundInitiatedEvent event = PaymentRefundInitiatedEvent.newBuilder().setPaymentId(paymentId)
                .setRefundId(refundId).setOrderId(orderId).setUserId(userId).setEmail(null)
                .setRefundAmount(refundAmount).setReason(reason).setTimestamp(now()).build();
    ...
    public void publishRefundCompleted(String paymentId, String refundId, String orderId, String userId,
            String refundAmount) {
        PaymentRefundCompletedEvent event = PaymentRefundCompletedEvent.newBuilder().setPaymentId(paymentId)
                .setRefundId(refundId).setOrderId(orderId).setUserId(userId).setEmail(null)
